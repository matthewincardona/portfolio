      ...
      <div class="case-study">
        ...
        <section>
          ...
          <div class="case-study__row">
            ...
            <div class="case-study__flex">
              <img class="case-study__img" src="./assets/second-desk/competitive positioning analysis.png" alt=""
                loading="lazy">
            </div>
            ...
            <div class="case-study__flex">
              <img class="case-study__img" src="./assets/second-desk/competitive-positioning-analysis-2.png" alt=""
                loading="lazy">
            </div>
          </div>
        </section>
        ...
        <div class="bg-wrapper">
          <section>
            <div class="case-study__row">
              ...
              <div class="case-study__flex">
                <img class="case-study__img" src="./assets/second-desk/product offering.png" alt="" loading="lazy">
              </div>
        ...
        <section>
          ...
          <div class="case-study__row">
            ...
            <p>
              While conducting interviews, I wanted to understand common challenges our target audience faces while
              working on their computer(s). I created a basic list of interview questions:</p>
        ...
        <div class="bg-wrapper">
          <section>
            <div class="case-study__row">
              <h4>User Personas</h4>
              <p>
                These represent some of the first personas we made. As we are constantly conducting more interviews and
                revising our work, updates will be made when new content is available.</p>
              <div class="case-study__flex">
                <img class="case-study__img" src="./assets/second-desk/User Persona 1.webp" alt="" loading="lazy">
                <img class="case-study__img" src="./assets/second-desk/User Persona 2.webp" alt="" loading="lazy">
              </div>
            </div>
          </section>
        </div>
        ...
        <section>
          <div class="case-study__row">
            <h4>Empathy Maps</h4>
            <div class="case-study__flex">
              <img class="case-study__img case-study__img--small" src="./assets/second-desk/Empathy map 1.webp" alt=""
                loading="lazy">
              <img class="case-study__img case-study__img--small" src="./assets/second-desk/Empathy map 2.webp" alt=""
                loading="lazy">
            </div>
          </div>
        </section>
        ...
        <div class="bg-wrapper">
          <section>
            <div class="case-study__row">
              ...
              <p>Home page</p>
              <div class="case-study__flex">
                <img class="case-study__img" src="./assets/second-desk/Home Screen.png" alt="" loading="lazy">
              </div>
              <p>Select a plan</p>
              <div class="case-study__flex">
                <img class="case-study__img" src="./assets/second-desk/Plan Selection Screen.png" alt="" loading="lazy">
              </div>
              <p>Desktop</p>
              <div class="case-study__flex">
                <img class="case-study__img" src="./assets/second-desk/Desktop Screen.png" alt="" loading="lazy">
              </div>
            </div>
          </section>
        </div>
          ...
          <section>
            <div class="case-study__row">
              ...
              <ul>
                ...
                <li>The AWS instance lacked a dedicated GPU, bottlenecking the performance of some programs.</li>
              </ul>
              <br /><br />
              <p>
                Finding new remote desktop software was our main prirority, so after researching the stacks behind cloud
                gaming services like Google Stadia (who excelled at remote app streaming), we found that a WebRTC-based
                approach looked the most promising. Althought, we are still in the process of looking for ways to
